...

                    {
                        user ? <>
                            <div className="navbar-end flex items-center gap-3">
                                <button onClick={handleLogout} className="relative text-sm rounded px-4 py-2 overflow-hidden group bg-[#0066ff10] hover:bg-gradient-to-r hover:from-[#0066ff10] hover:to-[#0066ff04]  hover:ring-2 hover:ring-offset-2 hover:ring-blue-400 transition-all ease-out duration-300">
